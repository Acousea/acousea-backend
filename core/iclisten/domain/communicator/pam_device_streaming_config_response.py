...
class PAMDeviceStreamingConfigCommunicationResponse(CommunicationResponse):
    ...
    def __str__(self):
        return (f"PAMDeviceStreamingConfigCommunicationResponse(record_waveform={self.record_waveform},"
